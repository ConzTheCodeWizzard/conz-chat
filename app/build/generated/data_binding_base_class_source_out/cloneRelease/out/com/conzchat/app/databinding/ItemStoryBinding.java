...
public final class ItemStoryBinding implements ViewBinding {
  ...
  private ItemStoryBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivAvatar,
      @NonNull ImageView ivRing, @NonNull TextView tvName) {
  ...
  public static ItemStoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.ivRing;
      ImageView ivRing = ViewBindings.findChildViewById(rootView, id);
      if (ivRing == null) {
        break missingId;
      }
      ...
      return new ItemStoryBinding((LinearLayout) rootView, ivAvatar, ivRing, tvName);
    }
