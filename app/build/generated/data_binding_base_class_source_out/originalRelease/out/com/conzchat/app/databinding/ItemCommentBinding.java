...
public final class ItemCommentBinding implements ViewBinding {
  ...
  private ItemCommentBinding(@NonNull LinearLayout rootView, @NonNull CircleImageView ivAvatar,
      @NonNull TextView tvCommentText, @NonNull TextView tvTime, @NonNull TextView tvUsername) {
  ...
  public static ItemCommentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCommentBinding((LinearLayout) rootView, ivAvatar, tvCommentText, tvTime,
          tvUsername);
    }
